...
When trying to get a reasonable time series it is important to understand the influence of the different parameters.
...
Compare to implementation in Clarke: mu = time. sliding windows
