...
In the last step we used a generalised Ito isometry. Deriving both sides with respect to time and considering the stationary limit gives us:
\[
...
\]
where the last step is similarly deduced as for $\Sigma$. 
