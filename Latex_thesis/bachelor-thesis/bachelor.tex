...
\[
(G_{WL}^{WL}[Y]_{\omega})_{j} = \lvert \frac{1}{\sqrt{WL}}\sum_{k=0}^{WL-1}\exp(i\omega k)Y_{jWL + k} \rvert ^2, \ \ j \in \{0,...,49\}, \ Y \in \{\widehat{X}, \widehat{\xi}\}
\]
...
\begin{figure}[b]
    \centering
    \includegraphics[width=0.9\textwidth]{bachelor-thesis/figures/19_8_se_ROSA.jpg}
